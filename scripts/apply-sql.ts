...
async function run() {
  await sql.unsafe(`
    ALTER TABLE "user_progress" ADD COLUMN IF NOT EXISTS "signal_registration_id" integer;
    ALTER TABLE "user_progress" ADD COLUMN IF NOT EXISTS "signal_identity_key" text;
