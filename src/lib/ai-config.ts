/**
 * Language-specific AI persona configuration.
 *
 * Each language entry defines a TTS voice code and a unique AI "persona"
 * (name, role, personality description) that is injected into every
 * Gemini prompt to produce culturally-appropriate, character-consistent
...
/**
 * Resolves the AI persona profile for a given language code.
 * Falls back to the default language (English) if the code is unknown.
 *
 * @param langCode - ISO 639-1 language code (e.g. "en", "es", "fr").
 * @returns The language config including voice code and persona details.
 */
