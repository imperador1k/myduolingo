        ...
        <div className="flex justify-between items-center p-2 group">
            <div className="flex items-center gap-4">
                <div className={cn(
                    ...
                    enabled 
                        ? "bg-stone-50 text-[#58cc02] border-stone-200 border-b-4" 
                        : "bg-stone-50 text-stone-400 border-stone-200 border-b-4"
                )}>
                ...
                <div className="flex flex-col">
                    ...
                    <p className="text-sm text-stone-400 font-bold mt-1">Recebe alertas.</p>
                </div>
            </div>
            ...
            <button 
                ...
                className={cn(
                    ...
                    enabled ? "bg-[#58cc02] border-2 border-[#46a302] border-b-4 translate-y-[-2px] active:translate-y-0 active:border-b-2" : "bg-stone-200 border-2 border-stone-300 border-b-4 translate-y-[-2px] active:translate-y-0 active:border-b-2"
                )}
                role="switch"
            ...
            >
                ...
                <span 
                    className={cn(
                        "pointer-events-none inline-block h-6 w-6 transform rounded-full bg-white shadow-sm ring-0 transition duration-300 ease-in-out border-b-2 border-stone-100",
